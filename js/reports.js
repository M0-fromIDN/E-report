// reports.js (fixed)
const container = document.getElementById('reportList'); // was 'report-list'
      ...
      <div class="col-md-4">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <span class="badge bg-${r.status === 'Finished' ? 'success' : r.status === 'Processing' || r.status === 'Processed' ? 'warning' : 'secondary'}">
              ${r.status}
            </span>
